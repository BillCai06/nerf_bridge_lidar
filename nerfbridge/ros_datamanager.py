...
from nerfbridge.ros_dataset import ROSDataset, ROSDepthDataset, ROSLidarDataset
...
class ROSDataManager(
    ...
    train_dataset: Union[ROSDataset, ROSDepthDataset, ROSLidarDataset]
    ...
    def setup_train(self):
        ...
        self.train_ray_generator = RayGenerator(self.train_dataset.cameras, self.train_camera_optimizer,)
