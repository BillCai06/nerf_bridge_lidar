...
class ROSSplatfactoModel(SplatfactoModel):
    ...
    def seed_from_xyzrgb(
        ...
        """
        Initialize gaussians at random points in the point cloud from the xyzrgb data.
        Means - Initialized to the xyz points.
        Scales - Initialized using k-nearest neighbors approach.
        Quats - Initialized to random.
